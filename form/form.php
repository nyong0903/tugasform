...
<div class="form-group">
  ...
  <div class="col-md-8">
    <div class="input-group">
      ...
      <input id="prependedtext" name="prependedtext" class="form-control" placeholder="Arlan" type="text" required="">
    </div>
...
<div class="form-group">
  ...
  <div class="col-md-8">
  <input id="textinput" name="textinput" type="text" placeholder="21" class="form-control input-md" required="">
